...
impl LogWatcher {
    ...
    fn parse_line(&self, line: &str) -> Option<LogEvent> {
        // Early return for most lines to avoid processing
...
mod tests {
    ...
    fn test_parse_line_player_joined() {
        ...
        let line = "2026.03.08 01:14:09 [Behaviour] OnPlayerJoined PlayerOne (usr_1234-5678)";
        let event = watcher.parse_line(line).unwrap();
    ...
    fn test_parse_line_player_left() {
        ...
        let line = "2026.03.08 01:14:09 [Behaviour] OnPlayerLeft PlayerOne (usr_1234-5678)";
        let event = watcher.parse_line(line).unwrap();

...
mod tests {
    ...
    #[test]
    fn test_format_translation_basic() {
        let template = "Hello, {}!";
        let args = vec!["World".to_string()];
        assert_eq!(format_translation(template, &args), "Hello, World!");
    }

    #[test]
    fn test_format_translation_multiple() {
        let template = "{} + {} = {}";
        let args = vec!["1".to_string(), "2".to_string(), "3".to_string()];
        assert_eq!(format_translation(template, &args), "1 + 2 = 3");
    }

    #[test]
    fn test_format_translation_complex_placeholder() {
        let template = "Value: {:.2f}";
        let args = vec!["3.14".to_string()];
        assert_eq!(format_translation(template, &args), "Value: 3.14");
    }

    #[test]
    fn test_format_translation_missing_args() {
        let template = "Hello {}, {}!";
        let args = vec!["World".to_string()];
        assert_eq!(format_translation(template, &args), "Hello World, {}!");
    }
    ...
    #[test]
    fn test_format_translation_missing_args_complex() {
        let template = "Value: {:.2f}, Size: {:?}";
        let args = vec!["3.14".to_string()];
        assert_eq!(
    ...
    #[test]
    fn test_format_translation_extra_args() {
        let template = "Hello {}";
        let args = vec!["World".to_string(), "Extra".to_string()];
        assert_eq!(format_translation(template, &args), "Hello World");
    }

    #[test]
    fn test_format_translation_unclosed_brace() {
    ...
    #[test]
    fn test_format_translation_empty() {
        let template = "";
        let args = vec![];
        assert_eq!(format_translation(template, &args), "");
    }
}
